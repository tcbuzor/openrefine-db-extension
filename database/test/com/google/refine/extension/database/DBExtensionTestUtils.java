...
public class DBExtensionTestUtils {
    ...
    private static final String DB_NAME = "openrefine";
    ...
    public void generateTestData() {
        ...
        dc.setDatabaseHost(DB_HOST);
        dc.setDatabaseName(DB_NAME);
        dc.setDatabasePassword(DB_PASSWORD);
        dc.setDatabasePort(DB_PORT);
        dc.setDatabaseType(DB_TYPE);
        dc.setDatabaseUser(DB_USER);
        dc.setUseSSL(false);
        ...
        Connection conn;
        try {
            conn = DatabaseService.get(DB_TYPE).getConnection(dc);
